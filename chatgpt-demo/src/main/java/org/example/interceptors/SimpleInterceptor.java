...
//        req.addHeader("Content-Type","application/json");
        req.addHeader("Authorization", "Bearer "+ CommonConstant.API_KEY);  // 添加Header
        req.addHeader("OpenAI-Organization", CommonConstant.ORGANIZATION);  // 添加URL的Query参数
        // 构建Forest正向代理对象
// 设置代理服务器的主机地址和端口号
        ForestProxy proxy = new ForestProxy("127.0.0.1", 7890);
// 设置代理服务验证的用户名和密码
